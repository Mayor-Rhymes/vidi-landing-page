...
export default function MissionVision() {
  return (
    <div className="py-10 flex flex-col gap-20 w-full">
      ...
      <div>
        <div className="flex justify-center items-center gap-10">
          ...
          <div className="flex flex-col h-[500px] w-[500px] items-center justify-center">
        ...
        <div className="flex justify-center flex-row-reverse items-center gap-10">
          ...
          <div className="flex flex-col justify-center h-[500px] w-[500px]">
            <h3 className="text-center uppercase text-xl font-bold">
              Our Vision
            </h3>
            <p className="">
